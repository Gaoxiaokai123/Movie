 ...
 * @Description: home点击更多跳转展示列表的适配器
 */
public class GengduoAdapter extends RecyclerView.Adapter<GengduoAdapter.myHolder> {
    ...
    public void onBindViewHolder(@NonNull myHolder myHolder, int i) {
        ...
        myHolder.pingfen.setText("评分"+list.get(i).score);

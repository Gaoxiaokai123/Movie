 ...
 */
public class ComingSoonMovieListPresenter extends BasePresenter {
    public ComingSoonMovieListPresenter(CallBackT callBackT) {
        super(callBackT);
    }

    @Override
    protected Observable getModel(IRequest iRequest, Object... args) {
        return iRequest.findComingSoonMovieList((int)args[0],(int)args[1]);
    }
}
